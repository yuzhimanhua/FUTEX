...
if args.mnli == 0:
	with open(f'{dataset}/{dataset}_papers.json') as fin0, \
		 open(f'{dataset}/{dataset}_predictions_fute_1.json') as fin1, \
		 open(f'{dataset}/{dataset}_predictions_specter_full.json') as fin2, \
		 open(f'{dataset}/{dataset}_predictions_fute_2.json', 'w') as fout:
