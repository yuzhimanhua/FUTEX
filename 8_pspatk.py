...
parser.add_argument('--patk', type=int, default=0)
args = parser.parse_args()

preds = []
targets = []
with open(f'{args.dataset}/{args.dataset}_predictions_{args.model}.json') as fin1, \
	 open(f'{args.dataset}/{args.dataset}_predictions_micol.json') as fin2:
	for line1, line2 in zip(fin1, fin2):
		data1 = json.loads(line1)
		data2 = json.loads(line2)
		targets.append(data2['label'])
		pred = [x[0] for x in data1['predictions']]
...
print('PSP@1:', psp1, ', ', \
	  ...
	  'PSN@3:', psn3, ', ', \
	  'PSN@5:', psn5)
with open('pspatk.txt', 'a') as fout:
